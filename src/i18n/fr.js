...
export default {
  ...
  hero: {
    nameWord: 'flora',
    roleWord: 'designer',
    roles: ['expérience UX', 'recherche UX', 'gestion de produit', 'communication', 'design produit'],
    scroll: 'Défiler',
    subhead: 'on discute ?',
  ...
  work: {
    ...
    projects: [
      ...
      },
      {
        ...
        tag: 'Journalisme',
        subtitle: 'Self-initiated',
        title: 'Protéger les lecteurs du clickbait et des articles écrits par des bots pendant leur navigation',
        year: '2019',
